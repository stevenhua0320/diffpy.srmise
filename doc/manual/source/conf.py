...
latex_documents = [
  ('index', 'SrMise_manual.tex', u'SrMise Documentation',
   ab_authors, 'manual'),
]
...
man_pages = [
    ('index', 'srmise', u'SrMise Documentation',
     ab_authors, 1)
]
...
texinfo_documents = [
  ('index', 'SrMise', u'SrMise Documentation',
   ab_authors, 'SrMise', 'One line description of project.',
   'Miscellaneous'),
]
